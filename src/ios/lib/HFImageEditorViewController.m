...
- (void)setCropRect:(CGRect)cropRect
{
    ...
    NSLog(@"cropSize %f,%f",self.frameView.cropRect.size.width,self.frameView.cropRect.size.height);
}
...
- (void)setCropSize:(CGSize)cropSize
{
    ...
    //NSLog(@"setCropSize %f,%f",cropSize.width,cropSize.height);
}
...
{    
    ...
    NSLog(@"cropRect height ＝ %f,width=%f",cropRect.size.height,cropRect.size.width);
    NSLog(@"aspect=%f",aspect);
    
    CGSize outputSize = CGSizeMake(outputWidth, outputWidth*aspect);
    NSLog(@"outputSize height ＝ %f,width=%f",outputSize.height,outputSize.width);
    ...
    NSLog(@"imageViewSize height ＝ %f,width=%f",imageViewSize.height,imageViewSize.width);
